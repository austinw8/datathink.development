...
```{r flight delays per month, echo=FALSE, include=FALSE}
...
![](images/Higher Flight Delay times in summer months)
...
```{r Number of flights per month, echo=FALSE, include=FALSE}
flights_per_month <- 
  flights |> 
  group_by(month) |> 
  summarise(count = n())
...
![](images/number of flights per month)
...
```{r distribution of flight delays, echo=FALSE, include=FALSE}
dep_delay_distr <- 
  flights |> 
...
![](images/distribution of delay times)
